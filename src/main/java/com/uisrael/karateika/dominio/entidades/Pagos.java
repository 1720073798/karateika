...
public class Pagos implements Serializable{
	...
	public String toString() {
		return "Pagos [pag_id=" + pag_id + ", com_id=" + com_id + ", alu_id=" + alu_id + ", pag_mes=" + pag_mes
				+ ", pag_anio=" + pag_anio + ", pag_fecha_pago=" + pag_fecha_pago + ", pag_metodo_pago="
				+ pag_metodo_pago + ", pag_numero_recibo=" + pag_numero_recibo + ", pag_observacion=" + pag_observacion
				+ ", pag_monto=" + pag_monto + ", pag_registrado_por=" + pag_registrado_por + ", pag_fecha_registro="
				+ pag_fecha_registro + "]";
	}
