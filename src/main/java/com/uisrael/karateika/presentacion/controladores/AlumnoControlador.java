...
public class AlumnoControlador {
	...
	@GetMapping("/buscarid/{idAlumno}")
	public AlumnoResponseDTO buscarPorId(@PathVariable int idAlumno) {
		return alumnoDTOMapper.toResponseDto(alumnoUseCase.obtenerPorId(idAlumno));
